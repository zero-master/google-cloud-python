...
class LanguageServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.ClassifyText = channel.unary_unary(
        ...
        request_serializer=google_dot_cloud_dot_proto_dot_language_dot_v1beta2_dot_language__service__pb2.ClassifyTextRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_proto_dot_language_dot_v1beta2_dot_language__service__pb2.ClassifyTextResponse.FromString,
        )
...
def add_LanguageServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'ClassifyText': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=google_dot_cloud_dot_proto_dot_language_dot_v1beta2_dot_language__service__pb2.ClassifyTextRequest.FromString,
          response_serializer=google_dot_cloud_dot_proto_dot_language_dot_v1beta2_dot_language__service__pb2.ClassifyTextResponse.SerializeToString,
      ),
