...
# source: google/cloud/proto/speech/v1p1beta1/cloud_speech.proto
...
RecognizeRequest = _reflection.GeneratedProtocolMessageType('RecognizeRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.cloud.proto.speech.v1p1beta1.cloud_speech_pb2'
  ,
...
RecognitionConfig = _reflection.GeneratedProtocolMessageType('RecognitionConfig', (_message.Message,), dict(
  ...
  Attributes:
      ...
      enable_word_time_offsets:
          *Optional* If ``true``, a list of ``words`` are returned in
          the top result, containing the start and end timestamps for
          those words. The default value, 'false' does not return any
...
RecognitionMetadata = _reflection.GeneratedProtocolMessageType('RecognitionMetadata', (_message.Message,), dict(
  ...
  Attributes:
      ...
      number_of_speakers:
          How many people are speaking prominently in the audio and
...
StreamingRecognizeResponse = _reflection.GeneratedProtocolMessageType('StreamingRecognizeResponse', (_message.Message,), dict(
  ...
  7. speech\_event\_type: END\_OF\_SINGLE\_UTTERANCE
  ...
  -  Only two of the above responses #4 and #8 contain final results; they
  ...
  Attributes:
      alternatives:
          *Output-only* May contain one or more recognition hypotheses
          ...
          alternatives are ordered in terms of accuracy, with the
          first/top alternative being the most probable, as ranked by
          the recognizer.
  """,
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\032com.google.cloud.speech.v1B\013SpeechProtoP\001ZCgoogle.golang.org/genproto/googleapis/cloud/speech/v1p1beta1;speech\370\001\001'))
try:
