...
class RecognitionMetadata(object):
    ...
    class NumberOfSpeakers(object):
        """
        How many speakers expected in the speech to be recognized.

        Attributes:
          NUMBER_OF_SPEAKERS_UNSPECIFIED (int): Unknown number of persons speaking.
          ONE_SPEAKER (int): Only one person is the prominent speaker (ignore background voices).
          TWO_SPEAKERS (int): Two people are the prominent speakers (transcript should focus
            on the two most prominent speakers).
          MULTIPLE_SPEAKERS (int): Transcribe all voices.
        """
