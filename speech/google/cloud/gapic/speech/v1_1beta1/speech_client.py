...
# https://github.com/google/googleapis/blob/master/google/cloud/speech/v1_1beta1/cloud_speech.proto,
...
from google.cloud.gapic.speech.v1_1beta1 import enums
from google.cloud.proto.speech.v1_1beta1 import cloud_speech_pb2
...
class SpeechClient(object):
    ...
    def recognize(self, config, audio, options=None):
        ...
        Example:
          >>> from google.cloud.gapic.speech.v1_1beta1 import speech_client
          >>> from google.cloud.gapic.speech.v1_1beta1 import enums
          >>> from google.cloud.proto.speech.v1p1beta1 import cloud_speech_pb2
        ...
        Args:
          config (:class:`google.cloud.proto.speech.v1p1beta1.cloud_speech_pb2.RecognitionConfig`): *Required* Provides information to the recognizer that specifies how to
            process the request.
          audio (:class:`google.cloud.proto.speech.v1p1beta1.cloud_speech_pb2.RecognitionAudio`): *Required* The audio data to be recognized.
          options (:class:`google.gax.CallOptions`): Overrides the default
            settings for this call, e.g, timeout, retries etc.

        Returns:
          A :class:`google.cloud.proto.speech.v1p1beta1.cloud_speech_pb2.RecognizeResponse` instance.
    ...
    def streaming_recognize(self, requests, options=None):
        ...
        Args:
          requests (iterator[:class:`google.cloud.proto.speech.v1p1beta1.cloud_speech_pb2.StreamingRecognizeRequest`]): The input objects.
          options (:class:`google.gax.CallOptions`): Overrides the default
            settings for this call, e.g, timeout, retries etc.

        Returns:
          iterator[:class:`google.cloud.proto.speech.v1p1beta1.cloud_speech_pb2.StreamingRecognizeResponse`].
