...
from google.cloud.proto.videointelligence.v1beta2 import video_intelligence_pb2
...
class VideoIntelligenceServiceClient(object):
    ...
    def annotate_video(self,
        ...
        Args:
          ...
          features (list[~.enums.Feature]): Requested video annotation features.
          input_content (bytes): The video data bytes. Encoding: base64. If unset, the input video(s)
            should be specified via ``input_uri``. If set, ``input_uri`` should be unset.
          video_context (Union[dict|:class:`google.cloud.proto.videointelligence.v1beta2.video_intelligence_pb2.VideoContext`]): Additional video context and/or feature-specific parameters.
            If a dict is provided, it must be of the same form as the protobuf
            message :class:`google.cloud.proto.videointelligence.v1beta2.video_intelligence_pb2.VideoContext`
